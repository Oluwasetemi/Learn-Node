...
exports.getStoresByTag = async (req, res) => {
	...
	const countPromise = Store
		.find({ tags: tagQuery })
		.count()

	const [tags, stores, count] = await Promise.all([tagsPromise, storePromise, countPromise])
...
exports.heartStore = async (req, res) => {
	const hearts = req.user.hearts.map(
		obj => obj.toString()
	)
